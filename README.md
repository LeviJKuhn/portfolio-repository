...
|--------|----------------|
| ✏️ EDIT #1 | Page title (browser tab text) |
| ✏️ EDIT #2 | Your name in the navigation bar |
| ✏️ EDIT #3 | Hero section — your name + intro sentence |
| ✏️ EDIT #4 | About Me — your initials/photo, bio, quick facts |
| ✏️ EDIT #5 | Your skills (add/remove `<li>` chips) |
| ✏️ EDIT #6 | Your ML projects (3 cards — the important part!) |
| ✏️ EDIT #7 | Your journey/education timeline |
| ✏️ EDIT #8 | Contact — email, GitHub, LinkedIn |
| ✏️ EDIT #9 | Footer — your name |
| ✏️ EDIT #10 | The "typing" phrases (this one is in `js/script.js`) |
